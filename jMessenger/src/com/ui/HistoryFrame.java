...
public class HistoryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setForeground(new Color(153, 255, 51));
        //jTable1.setFont(new Font("Comic Sans MS",Font.TYPE1_FONT, 12));
        ...
        jTable1.getTableHeader().setForeground(new Color(153, 255, 51));
        //jTable1.getTableHeader().setOpaque(false);
        //jTable1.setGridColor(new Color(153, 255, 51));
